...
echo ""
echo "⚠️  IMPORTANT: You need to activate the virtual environment first!"
echo ""
echo "To activate the virtual environment:"
echo "   source venv/bin/activate"
echo ""
echo "Then you can use the trade-executor command:"
echo "1. Edit .env file with your API credentials"
echo "2. Validate configuration: trade-executor config --validate"
echo "3. Get Bedrock setup guide: trade-executor setup-bedrock"
echo "4. Start trading: trade-executor start --demo"
echo ""
echo "For help: trade-executor --help"
echo ""
echo "⚠️  IMPORTANT: Start with demo mode first!"
echo "   trade-executor start --demo"
echo ""
